...
if (ll=="de")
    ...
    t = 'Âàø áğàóçåğ (%s) <b>óñòàğåë</b>. Îí èìååò <b>óÿçâèìîñòè â áåçîïàñíîñòè</b> è ìîæåò <b>íå ïîêàçûâàòü âñå âîçìîæíîñòè</b> íà ıòîì è äğóãèõ ñàéòàõ. <a target="_blank" href="http://browser-update.org/ru/update.html#5">Óçíàéòå, êàê îáíîâèòü Âàø áğàóçåğ</a>';
else if (ll=="id")
